...
function initModels(sequelize) {
  ...
  pedido_curso.belongsTo(formador, { as: "pedido_curso_formador", foreignKey: "formador_id"});
  formador.hasMany(pedido_curso, { as: "formador_pedido_cursos", foreignKey: "formador_id"});
