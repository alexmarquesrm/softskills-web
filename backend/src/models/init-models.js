...
function initModels(sequelize) {
  ...
  comentarios.belongsTo(colaborador, { as: "colaborador", foreignKey: "colaborador_id"});
  colaborador.hasMany(comentarios, { as: "comentarios", foreignKey: "colaborador_id"});
  ...
  threads.belongsTo(colaborador, { as: "colaborador", foreignKey: "colaborador_id"});
  colaborador.hasMany(threads, { as: "threads", foreignKey: "colaborador_id"});
  ...
  pedido_curso.belongsTo(curso, { as: "pedido_curso", foreignKey: "curso_id"});
  curso.hasMany(pedido_curso, { as: "curso_pedidos", foreignKey: "curso_id"});
  ...
  pedido_curso.belongsTo(formador, { as: "pedido_formador", foreignKey: "formador_id"});
  formador.hasMany(pedido_curso, { as: "formador_pedido", foreignKey: "formador_id"});
