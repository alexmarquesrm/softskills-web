...
CREATE TABLE TRABALHO (
   ...
   CONSTRAINT FK_TRABALHO_SINCrono FOREIGN KEY (SINCRONO_ID)
      REFERENCES SINCRONO (CURSO_ID),
   CONSTRAINT FK_TRABALHO_FORMANDO FOREIGN KEY (FORMANDO_ID)
      REFERENCES FORMANDO (FORMANDO_ID),
   CONSTRAINT FK_TRABALHO_MATERIAL FOREIGN KEY (MATERIAL_ID)
...
CREATE TABLE QUIZZ (
   ...
   DESCRICAO            TEXT NOT NULL,
   NOTA                 FLOAT NOT NULL,
   LIMITE_TEMPO         INTEGER NOT NULL DEFAULT 30,
...
CREATE TABLE AVALIACAO_FORMADOR (
   ...
   CONSTRAINT FK_AVALIACAO_FORMANDO FOREIGN KEY (FORMANDO_ID)
      REFERENCES FORMANDO (FORMANDO_ID),
   CONSTRAINT UK_AVALIACAO_FORMADOR_UNIQUE UNIQUE (CURSO_ID, FORMADOR_ID, FORMANDO_ID)
);