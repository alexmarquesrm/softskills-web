...
export default function UsersTable() {
  ...
  const tableColumns = [
    ...
    { field: 'status', headerName: ' ', flex: 0.5, headerAlign: 'left', sortable: false, renderCell: (row) => ( <Botao  onClick={() => alert("Botão clicado")} Icon={FaPencilAlt} />), disableColumnMenu: true },
  ];
