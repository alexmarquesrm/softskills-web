...
export default function Courses() {
    ...
    const fetchData = async () => {
        try {
            ...
            const response = await axios.get(`/curso/listpublic`, {
    ...
    const renderCourseCard = (curso, index) => (
        <FeaturedCourses key={curso.curso_id || index} curso={curso} mostrarEstado={false} mostrarBotao={false} mostrarCertificado={true} mostrarNivelCard={true} mostrarVagas={true} />
    );
